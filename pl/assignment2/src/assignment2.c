/*
 ...
 Class       	  : SE 9
 Name        	  : Kunal sachdev
 Assignment no    : 2(without pointer)
 Problem statement:
 ============================================================================
 */
#include <stdio.h>
...
void input(int mat[][10],int row,int col)//input function
{
	int i,j;
	for(i=0;i<row;i++)
	{
...
void display(int mat[][10],int row,int col)//display function
{
	int i,j;
	for(i=0;i<row;i++)
	{
...
saddle point found at 3 1 and value is 7
******menu******
1 for input
2 for display
3 for addition
